...
public class CWarriorAI : IAIBase {
    ...
    void Start ()
    {
        ...
        m_dictInventory[ Names.NAME_RAY ] = 0;
    }
    ...
    private void RunStates()
    {
		...
		if (m_fElapsedTime > m_fOldTime)
		{
            ...
            case EWarriorState.WARRIOR_ATTACKING:
                ...
                case EWarriorState.WARRIOR_DEAD:

                    // The warrior is dead, we have to clean up and get rid of it.
                    m_anAnimator.SetTrigger( AnimatorValues.ANIMATOR_IS_DEAD );
    ...
    private void RunIdleState()
    {
        ...
        if ( m_fHealth < Constants.DEFAULT_HEALTH_WARRIOR / 2 && false == m_bHasFlag )
        {
